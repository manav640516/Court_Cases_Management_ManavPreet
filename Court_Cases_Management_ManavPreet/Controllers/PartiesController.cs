...
namespace Court_Cases_Management_ManavPreet.Controllers
{
    ...
    public class PartiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Address,MobileNumber")] Party party)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Address,MobileNumber")] Party party)
        {
            if (id != party.ID)
            {
                return NotFound();
